...
if locale == "zhCN" then
L["ALWAYS_ALL"] = "显示所有任务"
L["ALWAYS_ALL_TT"] = "总是显示当前区域内所属资料片相关的所有任务"
L["AMOUNT_COLORS"] = "数量染色"
L["AMOUNT_COLORS_TT"] = "对任务列表内的某类型奖励，按数量多少进行染色"
L["AUTO_EMISARRY"] = "自动筛出大使任务"
L["AUTO_EMISARRY_TT"] = "点击世界地图奖励面板上的大使图标时，临时仅筛出大使任务"
L["BLIZZARD"] = "暴雪"
...
L["DEFAULT_TAB"] = "默认标签"
L["DEFAULT_TAB_TT"] = "将世界任务标签页设置为打开地图时默认显示的标签页"
...
L["FORMAT_GROUP_CREATE"] = "输入 |cFFFFFFFF%d|r 在组队查找器中创建此任务，或者输入其任务名：|cFFFFFFFF%s|r。考虑同时采取这两种操作来确保不用插件的玩家也可以在组队查找器中发现你创建的任务。"
L["FORMAT_GROUP_SEARCH"] = "输入 |cFFFFFFFF%d|r 在组队查找器中搜索这个任务，或者输入其任务名：|cFFFFFFFF%s|r。"
L["FORMAT_GROUP_TYPO"] = "看起来好像输入错了。输入|cFFFFFFFF%d|r，或|cFFFFFFFF%s|r。"
L["GENERIC_ANIMA"] = "统一心能图标"
L["GENERIC_ANIMA_TT"] = "将不同的心能物品图标全部替换成同样的，类似之前的艾泽里特。仅影响地图标记和任务列表的图标。"
L["GOLD_PURSES"] = "竞速钱袋视同金币"
L["GOLD_PURSES_TT"] = "将驭龙赛竞速者的钱袋视作金币类型的奖励"
...
L["LFG_BUTTONS_TT"] = "在目标追踪栏中添加组队查找器按钮。启用此设置可能会增加内存和 CPU 的使用率。|cFFFF5555 此设置需要重载用户界面后才能生效。|r"
L["LIST_COLOR_TIME"] = "时长染色"
L["LIST_COLOR_TIME_TT"] = "根据剩余时长染色。临终一刻染红"
L["LIST_FULL_TIME"] = "精确时间"
L["LIST_FULL_TIME_TT"] = "时长方面，天数精确到小时，小时精确到分钟"
L["LIST_SETTINGS"] = "列表设置"
L["LOAD_UTILITIES"] = "加载扩展"
L["LOAD_UTILITIES_TT"] = "加载扩展功能，如计数及计程排序。 |cFFFF5555禁用此功能后需要重载用户界面。|r"
L["LOAD_UTILITIES_TT_DISABLED"] = "|cFFFF5555World Quest Tab Utilities并未在您的插件列表中启用。|r"
L["MAP_FILTER_DISABLED"] = "世界地图追踪项未勾选"
L["MAP_FILTER_DISABLED_BUTTON_INFO"] = "右键点击重新启用此追踪项"
L["MAP_FILTER_DISABLED_INFO"] = "在您的世界地图放大镜中未勾选某些追踪项，这将隐藏列表中的一些任务，并停用一些追踪选项。"
L["MAP_FILTER_DISABLED_TITLE"] = "某些世界地图追踪项未勾选"
L["MAP_PINS"] = "任务点"
L["MINI_ICONS"] = "小图标"
L["NEW_PROFILE"] = "新配置文件"
...
L["PRECISE_FILTER"] = "精准过滤"
L["PRECISE_FILTER_TT"] = "只显示匹配所有过滤条件的任务，缺一不可"
...
L["SAVE_SETTINGS_TT"] = "在每次登入与重载时的过滤与排序设置"
...
L["TOMTOM_AUTO_ARROW_TT"] = "用 Shift+点击(左键) 或 右键下拉选单选项来追踪一个任务时，将自动创建一个TomTom导航点"
L["TOMTOM_CLICK_ARROW"] = "点击时添加导航点"
L["TOMTOM_CLICK_ARROW_TT"] = "为点击的世界任务创建 TomTom导航点，并移除其它通过此方式添加的导航点"
L["TOMTOM_PIN"] = "TomTom导航点"
L["TYPE_EMISSARY"] = "仅大使"
L["TYPE_EMISSARY_TT"] = "只显示大使任务，此过滤器将过滤其他追踪项"
L["TYPE_INVASION"] = "入侵"
L["UNINTERESTED"] = "忽略"
L["UNINTERESTED_TT"] = "在列表中显示已“忽略”的任务"
L["USE_TOMTOM"] = "启用TomTom导航"
L["USE_TOMTOM_TT"] = "本插件开启TomTom导航功能支持"
L["WHATS_NEW"] = "最近更新"
L["WHATS_NEW_TT"] = "查看World Quest Tab更新日志"
L["WQT_FULLSCREEN_BUTTON_TT"] = "点击(左键)来开关世界任务列表，右键按住并移动来改变位置"
...
L["GOLD_PURSES"] = "競速錢包視同金幣"
L["GOLD_PURSES_TT"] = "將競速騎師的錢包視作金幣類型的獎勵"
